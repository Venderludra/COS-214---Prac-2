...
int main() {
    ...
    cout << "1: the state pattern (aka movement)\n";
    ...
    cout << "2: the strategy pattern (aka the routes)\n";
    ...
    cout << "3: the composite (aka the map)\n" ;
    World world;
    ...
    cout << "4: the decorator (aka the place Features)\n";
    ...
    cout << "5: the abstract factory (aka the biomes)\n" << endl;
    ...
    //!Do NOT delete map nodes. World handles its own map cleanup.
